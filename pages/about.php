...
<body>
    ...
    <div class="container" style="margin-top: 7rem;">
        ...
        <div class="row ">
            ...
            <div class="col-8">
                <p class="justify-content-md-center">
                    Türkiye'nin iş bulma sorununu girişimcilik ile hızlandırmak vizyonu ile kurulan Ekmek<b>Teknesi</b> , Türkiye'de kolay iş, staj ve network bulma ve iletişimi kolaylaştırma misyonu ile çalışıyor.
                </p>
            </div>
            <div class="col-2"></div>
        </div>
        <div class="row ">
            ...
            <div class="col-8">
                <p class="justify-content-md-center">
                    Türkiye'nin dört bir yanında üniversite öğrencilerinin staj veya part-time, üniversite mezunlarının kendini geliştirmek ve tecrübe edinmek için iş aradığını biliyoruz. Bu konuda bizimle çalışan şirketlerin iş ilanı oluştururken
                    aynı zamanda her sene belirli miktar 'geliştirilmek üzere' eleman alarak zor durumlarla karşılaşan üniversite öğrencilerinin yollarındaki bir taşı kaldırmak için çabalıyoruz. Elbette tüm hedef kitlemiz üniversite öğrencileri değil
                    halihazırda bulunduğu işten ayrılmış, çıkarılmış kişilerin de iş bulabileceği ve katıldıkları ekiplerle daha iyi işler yapmalarını sağlamak amacıyla oluşturulmuş bir ekosistemiz.
                </p>
            </div>
            <div class="col-2"></div>
            <div class="row ">
