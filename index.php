...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 " style="background-color: #fff;" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.php"><img src="images/other/logo.png" alt="" width="30" /><span class="text-1000 fs-1 ms-2 fw-medium">Ekmek<span class="fw-bold">Teknesi</span></span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto border-bottom border-lg-bottom-0 pt-2 pt-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link disabled" href="pages/applications.php">İş İlanları</a></li>
                    <li class="nav-item"><a class="nav-link disabled" href="pages/" >İlan Ver</a></li>
                    <li class="nav-item"><a class="nav-link" href="pages/contact.php">İletişim </a></li>
                </ul>
                <form class="d-flex py-3 py-lg-0">

                    <a href="pages/register.php"> <button class="btn btn-link text-1000 fw-medium order-1 order-lg-0 text-decoration-none" type="button" style="color: grey;">Giriş Yap</button></a>
                    <a href="pages/register.php"> <button class="btn btn-outline-success rounded-pill order-0" type="button">Kayıt Ol</button></a>
    ...
    <div class="container">
        <div class="row flex-center ms-3">
            ...
            <div class="col-md-7 col-lg-6 mt-5 text-center text-md-start">
                <h1 class="fw-medium mt-5" style="font-family: 'Yellowtail', cursive; font-size:3.8rem;">Rüyalarınızdaki is<br />bir tık uzakta : <span class="" style="font-family: sans-serif; font-size:2.7rem">Ekmek<b>Teknesi</b></span></h1>
                <p class="mt-3 mb-4" style="font-size: 2rem; font-family: 'Quicksand', sans-serif;">Türkiye'nin dört bir yanında bulunan kişiler Ekmek<b>Teknesi</b> ile bir araya geliyor. İş bulmakta zorlanan, CV gönderip cevap alamayan, iş ilanı açıp istediği insanlara ulaşamayan iş verenler. Hepsi burada ...
                <span style="font-size: 1.2rem; color:grey"><i> İlanlara göz atmak ve ilan oluşturmak için giriş yap !</i></span>
                </p>
                <a class="btn btn-lg mt-2 btn-outline-danger rounded-pill btn-glow " href="pages/register.php">Keşfetmeye Başla &nbsp;<i class="far fa-paper-plane"></i> </a>
            </div>
        </div>
    </div>
    <!-- END JUMBOTRON -->
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <ul class="list-unstyled mb-md-4 mb-lg-0">
                            <li style="display: inline-block;" class="lh-lg "><a class="text-decoration-none btn btn-outline-secondary rounded-pill" style="color:black" href="pages/home.php"><i class="fas fa-home"></i>&nbsp;Anasayfa</a></li>
                            <li style="display: inline-block;" class="lh-lg ms-3 mt-2"><a class="text-decoration-none btn btn-outline-secondary rounded-pill" style="color:black" href="pages/about.php"><i class="fab fa-black-tie"></i>&nbsp;Hakkımızda</a></li>
                            <li style="display: inline-block;" class="lh-lg ms-3 mt-2"><a class="text-decoration-none btn btn-outline-secondary rounded-pill disabled" style="color:black" href="pages/applications.php"><i class="fas fa-server"></i>&nbsp;İlanlar</a></li>
                            <li style="display: inline-block;" class="lh-lg ms-3 mt-2"><a class="text-decoration-none btn btn-outline-secondary rounded-pill disabled" style="color:black" href="pages/advertise.php"><i class="fas fa-upload"></i>&nbsp;İlan Ver</a></li>
                            <li style="display: inline-block;" class="lh-lg ms-3 mt-2"><a class="text-decoration-none btn btn-outline-secondary rounded-pill" style="color:black" href="pages/contact.php"><i class="fas fa-envelope"></i>&nbsp;İletişim</a></li>
                            <li style="display: inline-block;" class="lh-lg ms-3 mt-2"><a class="text-decoration-none btn btn-outline-secondary rounded-pill disabled" style="color:black" href="pages/profile.php"><i class="fas fa-user"></i>&nbsp;Profil</a></li>
                        </ul>
                    </div>
                </div>
                <div class="row">
